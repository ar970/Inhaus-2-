...
const variants: Record<Exclude<Variant, "link">, string> = {
  solid:
    "bg-white text-dark hover:bg-gold hover:-translate-y-0.5 hover:shadow-[0_12px_26px_rgba(196,126,63,0.35)]",
  gold: "bg-gold text-dark hover:brightness-110 hover:-translate-y-0.5 hover:shadow-[0_16px_40px_rgba(196,126,63,0.5)]",
